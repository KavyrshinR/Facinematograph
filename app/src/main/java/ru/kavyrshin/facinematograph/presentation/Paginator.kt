package ru.kavyrshin.facinematograph.presentation
...
class Paginator<T>(
        private val requestFactory: (String, Int) -> Single<List<T>>,
    ...
    fun search(searchString: String) {
        currentState.search(searchString)
    }
    ...
    private fun loadPage(searchString: String, page: Int) {
        disposable?.dispose()
        disposable = requestFactory.invoke(searchString, page)
                .subscribe(
    ...
    private inner class EMPTY : State<T> {
        ...
        override fun search(searchString: String) {
            ...
            loadPage(searchString, FIRST_PAGE)
        }
    ...
    private inner class DATA : State<T> {
        ...
        override fun loadNewPage() {
            ...
            loadPage(currentSearch!!, currentPage + 1)
        }
